...
from model.model import BartForQuestionAnswering1
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        #raw_datasets = load_dataset('json', data_dir=data_args.dataset_name, name='squad_v2')
    else:
        data_files = {}
    ...
    if training_args.do_train:
        ...
        train_result = trainer.train(resume_from_checkpoint=None) #changed
