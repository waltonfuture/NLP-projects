...
#SBATCH --mem 20G
#SBATCH -a 0-31
#SBATCH -x gqxx-01-125,gqxx-01-179
#SBATCH --output=../log/pretrain/both-%A-%a.log

# ----------------------------------------- CONFIG ------------------------------------- #
DATA="/mnt/lustre/sjtu/home/dm311/remote/pretrain/data/pretrain" # data
OUTPUT_DIR="../ckpts/pretrain/both"                                   # output dir
...
LABEL_SMOOTHING_FACTOR=2e-6 # label smoothing factor
DECODERS="L2R,R2L"    # decoders
3=500          # logging steps
