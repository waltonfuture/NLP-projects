...
#SBATCH --output=../log/pretrain/bart-further-%A-%a.log

# ----------------------------------------- CONFIG ------------------------------------- #
DATA="/mnt/lustre/sjtu/home/dm311/remote/pretrain/data/pretrain" # data
OUTPUT_DIR="../ckpts/pretrain/bart"                                   # output dir
...
MODEL_NAME_OR_PATH="../ckpts/pretrain/bart/checkpoint-165000"                                        # MODEL CKPT, initialization
WITH_BART_INITIALIZE="facebook/bart-base"                        # The part of parameters to initialize
PER_DEVICE_TRAIN_BATCH_SIZE=2                                    # per device train batch size
