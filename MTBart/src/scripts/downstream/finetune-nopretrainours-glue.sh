...
#SBATCH --array=0-5
#SBATCH -J mnli
#SBATCH --output=/mnt/lustre/sjtu/home/lw023/remote/bart/results/oursnopretrain/log/MNLI/%A-%a.out
#SBATCH --error=/mnt/lustre/sjtu/home/lw023/remote/bart/results/oursnopretrain/log/MNLI/%A-%a.err
...
OUTPUT_DIR="/mnt/lustre/sjtu/home/lw023/remote/bart/results/oursnopretrain/predict/${TASK_NAME}/"

EPOCHS=3


python ../../downstream/run/finetune_seq_classification_ours_nopre.py \
