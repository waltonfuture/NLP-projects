...
#SBATCH --array=0-5
#SBATCH -J mnli
#SBATCH --output=/mnt/lustre/sjtu/home/lw023/remote/bart/results/bartnopretrain/log/MNLI/%A-%a.out
#SBATCH --error=/mnt/lustre/sjtu/home/lw023/remote/bart/results/bartnopretrain/log/MNLI/%A-%a.err
...
OUTPUT_DIR="/mnt/lustre/sjtu/home/lw023/remote/bart/results/bartnopretrain/predict/${TASK_NAME}/"

EPOCHS=3

CUDA_VISIBLE_DEVICES=1
 python ../../downstream/run/finetune_seq_classification_bart_nopre.py \
