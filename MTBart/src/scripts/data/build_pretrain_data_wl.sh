...
#SBATCH --mem=15G
#SBATCH -a 0
#SBATCH -o /mnt/lustre/sjtu/home/lw023/remote/datasets-wl/log/index.log

DATA="wiki" # book or wiki

BASE_PRETRAIN="/mnt/lustre/sjtu/home/lw023/remote/datasets-wl/pretrain"
BASE_BUFFER="/mnt/lustre/sjtu/home/lw023/remote/datasets-wl/buffer/${DATA}"
mkdir -p $BASE_BUFFER
...
TOTAL=$(ls ${DATA_DIR} | wc -l) #计算数据集中的总文件数
NODE_NUM=64 #设置计算节点数目
...
echo $blocks
OUTPUT_FILE="/mnt/lustre/sjtu/home/lw023/remote/pretrain/data/pretrain/train.large.txt"
